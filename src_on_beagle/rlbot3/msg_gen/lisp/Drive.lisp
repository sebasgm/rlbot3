...
(cl:defmethod cl:initialize-instance :after ((m <Drive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Drive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rlbot3-msg:<Drive> is deprecated: use rlbot3-msg:Drive instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rlbot3-msg:velocity-val is deprecated.  Use rlbot3-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <Drive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rlbot3-msg:radius-val is deprecated.  Use rlbot3-msg:radius instead.")
  (radius m))
